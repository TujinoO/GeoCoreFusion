...
class FusionConfig:
    ...
    factorization_method: str = "pca"
    simplex_factorization_iterations: int = 20
    simplex_factorization_tolerance: float = 1e-4
    simplex_residual_rank: int = 6
    coefficient_constraint: str = "unconstrained"
    ...
    coefficient_detail_method: str = "global_ridge"
    ...
    coefficient_detail_local_radius: int = 4
    coefficient_detail_local_ridge: float = 0.03
    coefficient_detail_local_correlation_floor: float = 0.10
    coefficient_detail_mtf_fine_sigma: float = 0.55
    coefficient_detail_mtf_upsample: str = "cubic"
    coefficient_detail_amplitude_recovery_limit: float = 1.60
    coefficient_detail_clip_coefficients: bool = True
    coefficient_detail_base_residual_keep: float = 1.0
    coefficient_detail_texture_coherence_floor: float = 0.10
    coefficient_detail_bridge_rank: int = 2
    coefficient_detail_bridge_block_rows: int = 2
    coefficient_detail_bridge_block_cols: int = 2
    coefficient_detail_bridge_cv_r2_floor: float = 0.0
    coefficient_detail_bridge_local: bool = False
    coefficient_detail_bridge_local_radius: int = 4
    coefficient_detail_bridge_local_correlation_floor: float = 0.10
    simplex_abundance_rgb_ridge: float = 0.02
    simplex_abundance_min_r2: float = 0.05
    simplex_abundance_detail_l1_limit: float = 0.25
    simplex_abundance_active_components: int = 2
    simplex_abundance_rgb_alignment_floor: float = 0.15
    intrinsic_detail_enabled: bool = False
    intrinsic_log_epsilon: float = 0.012
    dark_detail_boost: float = 0.0
    dark_detail_percentile: float = 20.0
    dark_texture_noise_floor: float = 0.012
    dark_texture_correlation_floor: float = 0.18
    dark_texture_window_radius: int = 3
    spatial_detail_method: str = "legacy"
    ...
    spatial_detail_log_gain: bool = False
    spatial_detail_log_detail_clip: float = 0.45
    spatial_detail_amplitude_recovery_limit: float = 1.50
    spatial_detail_confidence_mode: str = "exposure"
    spatial_detail_confidence_gate_low: float = 0.08
    spatial_detail_confidence_gate_high: float = 0.28
    spatial_detail_nullspace_iterations: int = 2
    spatial_detail_back_projection_iterations: int = 0
    spatial_detail_additive_mode: str = "legacy"
    ...
    spatial_detail_additive_correlation_floor: float = 0.08
    spatial_detail_additive_gain_clip: float = 3.0
    spatial_detail_additive_spectral_sigma: float = 2.0
    spatial_detail_product_back_projection_iterations: int = 0
    spatial_detail_product_back_projection_weight: float = 0.65
    spatial_detail_product_back_projection_clip_sigma: float = 0.35
    visual_detail_denoise_strength: float = 0.0
    visual_detail_pyramid_sigmas: tuple[float, ...] = (0.65, 1.35, 2.80, 5.60)
    visual_detail_pyramid_weights: tuple[float, ...] = (1.15, 1.00, 0.82, 0.58)
    visual_detail_chroma_weight: float = 0.28
    visual_detail_poisson_screen: float = 0.24
    visual_detail_gradient_weight: float = 1.0
    visual_detail_dark_boost: float = 0.20
    visual_detail_sharpen_strength: float = 0.22
    visual_detail_reflect_padding: int = 24
...
class OutputConfig:
    ...
    product_mode: str = "dual_scientific_visualization"
